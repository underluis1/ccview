...
export const MODEL_PRICING: PricingModel[] = [
  ...
  // ── Alias senza date suffix (come appaiono nei log di Claude Code) ──
  { id: 'claude-opus-4-6',    tier: 'opus',   label: 'Opus 4.6',   inputPer1M: 5,    cacheWrite5mPer1M: 6.25,  cacheWrite1hPer1M: 10,  cacheHitPer1M: 0.50, outputPer1M: 25   },
  { id: 'claude-sonnet-4-6',  tier: 'sonnet', label: 'Sonnet 4.6', inputPer1M: 3,    cacheWrite5mPer1M: 3.75,  cacheWrite1hPer1M: 6,   cacheHitPer1M: 0.30, outputPer1M: 15   },
  { id: 'claude-opus-4-5',    tier: 'opus',   label: 'Opus 4.5',   inputPer1M: 5,    cacheWrite5mPer1M: 6.25,  cacheWrite1hPer1M: 10,  cacheHitPer1M: 0.50, outputPer1M: 25   },
  { id: 'claude-sonnet-4-5',  tier: 'sonnet', label: 'Sonnet 4.5', inputPer1M: 3,    cacheWrite5mPer1M: 3.75,  cacheWrite1hPer1M: 6,   cacheHitPer1M: 0.30, outputPer1M: 15   },
  { id: 'claude-haiku-4-5',   tier: 'haiku',  label: 'Haiku 4.5',  inputPer1M: 1,    cacheWrite5mPer1M: 1.25,  cacheWrite1hPer1M: 2,   cacheHitPer1M: 0.10, outputPer1M: 5    },
  { id: 'claude-opus-4-1',    tier: 'opus',   label: 'Opus 4.1',   inputPer1M: 15,   cacheWrite5mPer1M: 18.75, cacheWrite1hPer1M: 30,  cacheHitPer1M: 1.50, outputPer1M: 75   },
  { id: 'claude-opus-4',      tier: 'opus',   label: 'Opus 4',     inputPer1M: 15,   cacheWrite5mPer1M: 18.75, cacheWrite1hPer1M: 30,  cacheHitPer1M: 1.50, outputPer1M: 75   },
  { id: 'claude-sonnet-4',    tier: 'sonnet', label: 'Sonnet 4',   inputPer1M: 3,    cacheWrite5mPer1M: 3.75,  cacheWrite1hPer1M: 6,   cacheHitPer1M: 0.30, outputPer1M: 15   },
  { id: 'claude-3-7-sonnet',  tier: 'sonnet', label: 'Sonnet 3.7', inputPer1M: 3,    cacheWrite5mPer1M: 3.75,  cacheWrite1hPer1M: 6,   cacheHitPer1M: 0.30, outputPer1M: 15   },
  { id: 'claude-3-5-sonnet',  tier: 'sonnet', label: 'Sonnet 3.5', inputPer1M: 3,    cacheWrite5mPer1M: 3.75,  cacheWrite1hPer1M: 6,   cacheHitPer1M: 0.30, outputPer1M: 15   },
  { id: 'claude-3-5-haiku',   tier: 'haiku',  label: 'Haiku 3.5',  inputPer1M: 0.80, cacheWrite5mPer1M: 1,     cacheWrite1hPer1M: 1.6, cacheHitPer1M: 0.08, outputPer1M: 4    },
  { id: 'claude-3-haiku',     tier: 'haiku',  label: 'Haiku 3',    inputPer1M: 0.25, cacheWrite5mPer1M: 0.30,  cacheWrite1hPer1M: 0.50,cacheHitPer1M: 0.03, outputPer1M: 1.25 },
  // ── Claude 3.x legacy ──
